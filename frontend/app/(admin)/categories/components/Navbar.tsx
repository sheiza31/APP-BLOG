        ...
        <>
            <nav className="h-screen w-64 fixed left-0 top-0 border-r border-outline-variant dark:border-outline bg-surface-container-low dark:bg-surface-container-lowest z-10 flex flex-col h-full p-stack-md flat no shadows">
                <div className="mb-stack-xl flex items-center gap-3">
                    <img alt="The Insight Admin Logo" className="w-10 h-10 rounded-full object-cover" data-alt="A minimalist logo design for an editorial publication named 'The Insight'. The logo features Link sleek, abstract geometric shape resembling Link stylized pen nib or Link subtle eye motif, rendered in crisp black against Link pristine white background. The overall aesthetic is highly professional, clean, and modern, suitable for Link premium journalistic brand." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCTfSMqq9ukPLaKPC50G-dJN35Ev1GyWiJQrBbaRrIIfiXgu2HaMI0CzqlfgcZj0gjvdR1b0qOBrBTBxfJhs06sZEvMlW1DHxyD_pu5BgJzIEK4UUOhnOqxjLkg93sLmDKGJVEDhJ4nSIjg8AvsdxqCnIJ_aijH-tfFniy7g3j7_uH36fb6SS79aTZcrs8K2Sg_SC_R6Ay7fNlL_VGVTelmU8vVISluiFg4Yrh4LKf7VciI0AuOj92A" />
                    <div>
                ...
                <ul className="space-y-stack-sm flex-1 font-body-md text-body-md font-label-caps text-label-caps">
                    ...
                    <li>
                        <Link className="flex items-center gap-3 px-4 py-3 bg-secondary-container dark:bg-secondary text-on-secondary-container dark:text-on-secondary rounded-lg duration-200 ease-in-out" href="/categories">
